...
import com.superdroid.aws_login_test.common.Constants
...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun  tedPermission() {
        ...
        TedPermission.with(this)
            ...
            .setRationaleMessage(getResources().getString(com.superdroid.aws_login_test.R.string.permission_2))
            .setDeniedMessage(getResources().getString(com.superdroid.aws_login_test.R.string.permission_1))
    ...
    private fun init() {
        ...
        inputInfoMessage = arrayOf(getString(com.superdroid.aws_login_test.R.string.error_discorrent_email), getString(
            com.superdroid.aws_login_test.R.string.txtInputInfoPWD
        ), getString(R.string.txtInputInfoNick), getString(R.string.txtInputInfoAge), getString(R.string.txtInputInfoGender))
